...
def simple_bed():
    ...
    gr = pr.PyRanges(chromosomes=[1, 1, 1, 1, 1], starts=[
                     0, 10, 20, 30, 100], ends=[5, 15, 25, 35, 105])
...
def simple_m2():
    ...
    m2 = pr.PyRanges(chromosomes=[1, 1, 1, 1, 1], starts=[
                     0, 10, 30, 40, 55], ends=[5, 15, 35, 45, 55])
    m2.calls = [1, 1, 2, 3, 5]
